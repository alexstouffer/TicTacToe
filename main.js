...
document.getElementById("ticTacToe").addEventListener("click", function onClick(item) {
  ...
  var computerTDElement = getTDElementFromBoardElement(tdElement)[0];
  makeMove(tdElement);
...
function getTDElementFromBoardElement(routeObject) {
  ...
  for (var i = 0; i < elements.length; i++) {
    if (elements[i].dataset.row == routeObject.attributes["data-row"].value && elements[i].dataset.col == routeObject.attributes["data-col"].value) {
